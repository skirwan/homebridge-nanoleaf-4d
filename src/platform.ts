...
import { Nanoleaf4dAccessory } from './nanoleaf4dAccessory.js';
import type { Nanoleaf4DClient } from './nanoleaf4DClient.js';
import { MockNanoleaf4DClient } from './mockNanoleaf4dClient.js';
...
export class Nanoleaf4DPlatform implements DynamicPlatformPlugin {
  private readonly client: Nanoleaf4DClient = new MockNanoleaf4DClient();
